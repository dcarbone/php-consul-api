...
use DCarbone\PHPConsulAPI\Model\WriteOptions;

/**
 * Class Session
 * @package DCarbone\PHPConsulAPI\Client
 */
class Session extends AbstractClient
{
     ...
     * @param \DCarbone\PHPConsulAPI\Model\WriteOptions|null $writeOptions
     * @return array(
     *  @type string
     *  @type \DCarbone\PHPConsulAPI\Model\WriteMeta write metadata
     ...
     * @param \DCarbone\PHPConsulAPI\Model\WriteOptions|null $writeOptions
     * @return array(
     *  @type \DCarbone\PHPConsulAPI\Model\WriteMeta|null write metadata or null on error
     *  @type \DCarbone\PHPConsulAPI\Error|null error, if any
     * )
     */
     ...
     * @param \DCarbone\PHPConsulAPI\Model\WriteOptions|null $writeOptions
     * @return array(
     *  @type \DCarbone\PHPConsulAPI\Model\SessionEntry[]|null list of session entries or null on error
     *  @type \DCarbone\PHPConsulAPI\Model\WriteMeta|null write metadata or null on error
     *  @type \DCarbone\PHPConsulAPI\Error|null error, if any
     * )
     */
     ...
     * @return array(
     *  @type \DCarbone\PHPConsulAPI\Model\SessionEntry[]|null list of session entries or null on error / empty response
