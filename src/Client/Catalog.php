...
use DCarbone\PHPConsulAPI\Model\CatalogDeregistration;
use DCarbone\PHPConsulAPI\Model\CatalogNode;
use DCarbone\PHPConsulAPI\Model\CatalogRegistration;
 ...
 */
class Catalog extends AbstractClient
{
    /**
     * @param CatalogRegistration $catalogRegistration
     * @param WriteOptions|null $writeOptions
     * @return array(
     *  @type \DCarbone\PHPConsulAPI\Model\WriteMeta write meta data
