...
use DCarbone\PHPConsulAPI\Model\KVTree;
...
class KV extends AbstractClient
{
     ...
     *  @type \DCarbone\PHPConsulAPI\Model\QueryMeta|null query metadata object or null on error
     ...
     *  @type \DCarbone\PHPConsulAPI\Model\QueryMeta|null query metadata
     *  @type \DCarbone\PHPConsulAPI\Error|null error, if any
     * )
     */
    ...
    /**
     * @param KVPair $p
     * @param \DCarbone\PHPConsulAPI\Model\WriteOptions $writeOptions
     * @return array(
     ...
     * @return array(
     *  @type \DCarbone\PHPConsulAPI\Model\WriteMeta metadata about write
     *  @type \DCarbone\PHPConsulAPI\Error|null error, if any
     * )
     */
