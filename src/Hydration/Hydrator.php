<?php namespace DCarbone\PHPConsulAPI\Hydration;
...
use DCarbone\PHPConsulAPI\Model\AgentCheck;
use DCarbone\PHPConsulAPI\Model\AgentMember;
use DCarbone\PHPConsulAPI\Model\AgentSelf;
use DCarbone\PHPConsulAPI\Model\AgentSelfConfig;
use DCarbone\PHPConsulAPI\Model\AgentSelfCoord;
use DCarbone\PHPConsulAPI\Model\AgentService;
use DCarbone\PHPConsulAPI\Model\AgentServiceCheck;
use DCarbone\PHPConsulAPI\Model\CatalogNode;
use DCarbone\PHPConsulAPI\Model\CatalogService;
use DCarbone\PHPConsulAPI\Model\Coordinate;
use DCarbone\PHPConsulAPI\Model\CoordinateDatacenterMap;
use DCarbone\PHPConsulAPI\Model\CoordinateEntry;
use DCarbone\PHPConsulAPI\Model\HealthCheck;
use DCarbone\PHPConsulAPI\Model\KVPair;
use DCarbone\PHPConsulAPI\Model\ServiceEntry;
use DCarbone\PHPConsulAPI\Model\SessionEntry;
use DCarbone\PHPConsulAPI\Model\UserEvent;
