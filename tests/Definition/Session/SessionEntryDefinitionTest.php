<?php namespace DCarbone\PHPConsulAPITests\Definition\Session;
...
/**
 * Class SessionEntryDefinitionTest
 *
 * @internal
 */
final class SessionEntryDefinitionTest extends AbstractDefinitionTestCases
{
    /** @var bool */
