...
/*
   Copyright 2016-2017-2017 Daniel Carbone (daniel.p.carbone@gmail.com)
...
/**
 * Class RaftConfigurationDefinitionTest
 *
 * @internal
 */
final class RaftConfigurationDefinitionTest extends AbstractDefinitionTestCases
{
    /** @var bool */
