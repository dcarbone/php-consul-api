...
/**
 * Class OperatorHealthReplyDefinitionTest
 *
 * @internal
 */
final class OperatorHealthReplyDefinitionTest extends AbstractDefinitionTestCases
{
    /**
     * @return string
     */
    ...
    {
        return OperatorHealthReply::class;
    }
}
