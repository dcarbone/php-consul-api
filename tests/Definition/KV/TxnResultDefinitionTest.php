...
use DCarbone\PHPConsulAPI\KV\TxnResult;
use DCarbone\PHPConsulAPITests\Definition\AbstractDefinitionTestCases;

/**
 * Class TxnResultDefinitionTest
 *
 * @internal
 */
final class TxnResultDefinitionTest extends AbstractDefinitionTestCases
{
    /**
     * @return string
     */
