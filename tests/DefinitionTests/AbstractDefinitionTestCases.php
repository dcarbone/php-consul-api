...
abstract class AbstractDefinitionTestCases extends \PHPUnit_Framework_TestCase
{
    ...
    public function testClassConstructorImplementation()
    {
        ...
        if ($reflectionClass->hasMethod('__construct'))
        {
            ...
            foreach($constructorParameters as $i => $parameter)
            {
                ...
                $this->assertEquals($parameterParamTag->getVariableName(), $parameterName, sprintf(
                ...
                if (0 === $i)
                {
                    ...
                    $this->assertInstanceOf(Array_::class, $parameterParamType, sprintf(
                ...
                else
                {
                    ...
                    switch(true)
                    {
                        ...
                        case $parameterParamType instanceof Object_:
                            ...
                            $this->assertEquals($fqsn, $parameterClass, sprintf(
    ...
    protected function _assertCorrectSetterImplementation(\ReflectionClass $reflectionClass, \ReflectionProperty $reflectionProperty)
    {
        ...
        {
            $this->assertTrue(method_exists($className, $expectedSetterName), sprintf(
        ...
        switch(true)
        {
            ...
            case $propertyVarType instanceof Array_:
                $this->assertTrue($reflectionParameter->isArray(), sprintf(
            ...
            case $propertyVarType instanceof Object_:
                ...
                $this->assertEquals($fqsn, $parameterClass->getName(), sprintf(
